...
from transformers.generation.utils import GenerationMixin, GenerateNonBeamOutput, GenerateDecoderOnlyOutput, GenerateEncoderDecoderOutput
from transformers.generation.logits_process import LogitsProcessorList
from transformers.generation.stopping_criteria import StoppingCriteriaList
from transformers.generation.configuration_utils import GenerationConfig
from transformers.utils import logging

from avater_infer.modeling_outputs import Seq2SeqCausalLMOutputWithCrossAttentions
...
def sample_llm_tokens(
    ...
    **model_kwargs,
    ...
    while self._has_unfinished_sequences(
        ...
        outputs: Seq2SeqCausalLMOutputWithCrossAttentions = self.forward_llm(**model_inputs, return_dict=True)
        ...
        next_token_logits = outputs.decoder_logits.clone()[:, -1, :].float()
